...
@lazySingleton
final class WatchGroupByIdUseCase implements StreamUseCase<Group, String> {
  const WatchGroupByIdUseCase(this._groupsRepository);

  final GroupsRepository _groupsRepository;

  @override
  StreamEitherFailure<Group> call(String params) {
    return _groupsRepository.watchGroupById(params);
  }
}
